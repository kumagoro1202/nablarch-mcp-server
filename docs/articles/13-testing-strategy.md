...
2. [テスト全体像 — 1,019件のテストの内訳](#2-テスト全体像--1019件のテストの内訳)
...
本記事では、Nablarch MCP Serverの**1,019件のテスト**がどのように品質を守っているかを解説します。
...
- **Phase 4（品質基盤）**: +209件（ONNX Embedding、Actuator、HealthIndicator、構造化ログ、相関ID）

### 2.3 テスト成功率

最終テスト実行結果（2026-02-10）：

```
Tests run: 1019, Failures: 0, Errors: 0, Skipped: 14
Success rate: 98.63%
```

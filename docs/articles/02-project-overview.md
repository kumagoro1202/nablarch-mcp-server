...
| **Embeddingモデル（ドキュメント）** | Jina embeddings-v4 | 89言語対応、32Kコンテキスト、OSS |
| **Embeddingモデル（コード）** | Voyage-code-3 | Java/XMLに最高水準（CoIRベンチマーク） |
...
| **Phase 4** | 本番デプロイ | 未着手 | Docker Compose、OAuth 2.0、モニタリング等 |

### 8.2 テスト品質

現在の**Phase 3完結時点**での品質指標：
...
- **技術スタック**: Spring Boot + PostgreSQL + pgvector + Jina/Voyage
- **開発状況**: Phase 3完結、810件テスト、61 PR
...
- **[→ 次の記事: 03-セットアップガイド](03-setup-guide.md)**
- **[📚 記事一覧に戻る](INDEX.md)**
